    ...
    <article className="mx-auto max-w-2xl pt-4">
      ...
      <div className="prose">
        <p>
          ...
          or a tale told over a fire, stories are how we&rsquo;ve always
          met each other.
        </p>
        ...
        <p>
          ...
          places we&rsquo;ve never been &mdash; we receive almost all of it
          as story before we receive it as anything else.
        </p>

        <p>
          As a young kid I ventured out and found more stories, and I fell
          in love with them. Stories can be as huge as the{" "}
          <em>Iliad</em> or as small as one moment plucked from inside it.
          The grand epics and the grandmother&rsquo;s tales belong to the
          same family. They all need to be preserved, and they all deserve
          to be brought together.
        </p>

        <p>
          That&rsquo;s what this is. An open archive of human story &mdash;
          from mythology to folklore, from oral history to personal
          memory, from creation myths to a single afternoon someone
          doesn&rsquo;t want to forget. Anyone can contribute. The author
        ...
        <p style={{ color: "var(--color-ink-soft)" }}>&mdash; Viraat</p>
      </div>
    </article>
  );
}
